...
const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-64 bg-cyber-card border-r border-cyber-border/80 flex flex-col z-20 shrink-0">
      ...
      {/* SOC Info & Simulation Reset Panel */}
      <div className="p-4 border-t border-cyber-border/80 bg-cyber-bg/30">
        ...
        <button
          ...
          className="w-full flex items-center justify-center px-4 py-2.5 rounded-lg text-xs font-medium text-cyber-accent hover:bg-cyber-accent/10 border border-cyber-accent/20 hover:border-cyber-accent/40 transition-all gap-2 font-mono"
        >
